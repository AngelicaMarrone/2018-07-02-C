...
public class ExtFlightDelaysDAO {
	...
	public List<Airport> getVertex(Integer min, Map<Integer, Airport> idMap) {
		String sql = "SELECT * " + 
	...
	public List<Adiacenza> getEdges() {
		String sql = "SELECT a1.ID, a2.ID, COUNT(DISTINCT f.ID) as cnt " + 
		...
		try {
			...
			while (rs.next()) {
				Adiacenza a = new Adiacenza(rs.getInt("a1.ID"),rs.getInt("a2.ID"),rs.getDouble("cnt"));
				result.add(a);
