...
public class ExtFlightDelaysController {
    ...
    void doAnalizzaAeroporti(ActionEvent event) {
    		...
    		String mins= compagnieMinimo.getText();
    		...
    		min= Integer.parseInt(mins);}catch(NumberFormatException n) {txtResult.appendText("ERRORE: il formato è errato\n");
    		...
    		if (min<0)
    		{
    			txtResult.appendText("ERRORE: inserire solo valori positivi\n");
    		}

    		List<Airport> aeroporti=model.creaGrafo(min);
    ...
    void doCalcolaAeroportiConnessi(ActionEvent event) {
    	...
    	String ris= model.componenteConnessa(a);
